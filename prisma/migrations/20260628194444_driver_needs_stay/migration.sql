...
INSERT INTO "new_Car" ("carType", "confirmationNo", "createdAt", "driverCost", "driverMode", "endDate", "holdUntil", "id", "label", "notes", "rentalCost", "source", "startDate", "status", "tripId", "vendor") SELECT "carType", "confirmationNo", "createdAt", "driverCost", "driverMode", "endDate", "holdUntil", "id", "label", "notes", "rentalCost", "source", "startDate", "status", "tripId", "vendor" FROM "Car";
DROP TABLE "Car";
