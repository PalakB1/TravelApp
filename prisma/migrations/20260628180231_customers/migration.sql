...
INSERT INTO "new_Booking" ("createdAt", "customerName", "customerPhone", "discount", "discountReason", "flightAmount", "gstRate", "id", "landAmount", "nonTaxable", "packageType", "pax", "status", "tcsRate", "tripId", "variantId", "visaAmount") SELECT "createdAt", "customerName", "customerPhone", "discount", "discountReason", "flightAmount", "gstRate", "id", "landAmount", "nonTaxable", "packageType", "pax", "status", "tcsRate", "tripId", "variantId", "visaAmount" FROM "Booking";
DROP TABLE "Booking";
